...
<form action="ubicarCookie.php">
	<fieldset>
		...
		<label for="nombre">Nombre cookie</label> <input type="text"
			id="nombre" name="nombre"> <label for="contenido">Contenido cookie</label>
		<input type="text" id="contenido" name="contenido"> <br /> <label
