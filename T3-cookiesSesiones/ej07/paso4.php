...
$genero = $genero == null ? 'Género no definido' : $BDgeneros [$genero];
$casado = isset ( $_SESSION ['casado'] ) ? 'Sí' : 'No';
$hijos = isset ( $_SESSION ['hijos'] ) ? 'Sí' : 'No';
