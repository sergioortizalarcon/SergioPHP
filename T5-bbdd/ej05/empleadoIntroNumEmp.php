...
var conexion;
	...
	function accionAJAX() {
		...
		if (respuesta == 'ok') {
			document.getElementById("idMensaje").innerHTML='Usuario EXISTENTE';
		}
		else {
			document.getElementById("idMensaje").innerHTML='Usuario NO existente';
		}
}
	
	function comprobarNumEmp() {
		numemp = document.getElementById('idNumemp').value;
		conexion = new XMLHttpRequest();
		conexion.open('POST', 'ajaxEmpleadoExiste.php', true);
		conexion.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
		conexion.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		conexion.send('numemp='+numemp);
...
<body>
	<fieldset>
		...
		<form action="$script" method="post">
			...
			<input type="text" name="numemp" id="idNumemp" onkeyup="comprobarNumEmp()">
