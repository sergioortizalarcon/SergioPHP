...
<body>
	...
	<form name="f1" method="get">
		<fieldset>
			...
			<br /> <label for="apellido">Apellido</label> <input type="text"
				name="apellido" id="apellido" /> <br /> <br /> <input type="submit"
				value="Enviar datos" />
		</fieldset>
	</form>
	<form name="f2" method="get">
		<fieldset>
			...
			<label for="clave">Password</label> <input type="password"
				name="clave" /> <br /> <label for="ocultoVacio">Oculto vac&iacute;o</label>
			<input type="hidden" name="ocultoVacio" /> <br /> <label
				for="ocultoLleno">Oculto lleno</label> <input type="hidden"
				name="ocultoLleno" value="sorpresa" /> <br /> <input type="submit"
				value="Enviar datos" />
		</fieldset>
	</form>
	...
	<form name="f4" method="get">
		<fieldset>
			...
			<label for="radioVerde">Verde</label> <input type="radio"
				name="radioVerde" id="radioVerde" /> <label for="radioNaranja">Naranja</label>
			<input type="radio" name="radioNaranja" id="radioNaranja" /> <label
				for="radioRojo">Rojo</label> <input type="radio" name="radioRojo"
	...
	<form name="f5" method="get">
		<fieldset>
			...
			<label for="radioGenero">Mujer</label> <input type="radio"
				name="genero" id="genero" /> <label for="radioGenero">Hombre</label>
			<input type="radio" name="genero" id="genero" /> <label
				for="radioGenero">Otro</label> <input type="radio" name="genero"
				id="genero" /> <br /> <input type="submit" value="Enviar datos" />
		</fieldset>
	</form>
	<form name="f6" method="get">
		<fieldset>
			...
			<label for="radioCabello">Moreno</label> <input type="radio"
				...
				id="cabello" value="rubio" /> <label for="radioCabello">Pelirrojo</label>
	...
	<form name="f8" method="get">
		<fieldset>
			...
			<label for="checkAficion">Lectura</label> <input type="checkbox"
				name="checkAficion" id="checkAficion" /> <label for="checkAficion">Deporte</label>
			<input type="checkbox" name="checkAficion" id="checkAficion" /> <label
	...
	<form name="f9" method="get">
		<fieldset>
			...
			<label for="checkLectura">Lectura</label> <input type="checkbox"
				name="checkLectura" id="checkLectura" /> <label for="checkDeporte">Deporte</label>
			<input type="checkbox" name="checkDeporte" id="checkDeportes" /> <label
